...
public class CameraZoom : MonoBehaviour
{
    ...
    /// <summary>
    /// Raise the zoom in press event. canvas要用world Space才可以调节
    /// </summary>
    ...
    /// <summary>
    /// Raise the zoom in press release event. canvas要用world Space才可以调节
    /// </summary>
    ...
    /// <summary>
    /// Raise the zoom out press event. canvas要用world Space才可以调节
    /// </summary>
    ...
    /// <summary>
    /// Raise the zoom out press release event. canvas要用world Space才可以调节
    /// </summary>
